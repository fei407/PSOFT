...
class LoraLayer(BaseTunerLayer):
    ...
    def pissa_init(self, adapter_name, init_lora_weights):
        ...
        if init_lora_weights == "pissa" or init_lora_weights == "pissa_orth":
        ...
        if init_lora_weights == "pissa_orth":
            print(f"[Init] Using ‘pissa_orth’ initialization for MOFT | Adapter: '{adapter_name}'.")
            lora_A = Uhr
        ...
        self.lora_A[adapter_name].weight.data.copy_(lora_A)
        self.lora_B[adapter_name].weight.data.copy_(lora_B)
